...
for (lambda in c(1, 1.5, 5)) {
	...
	hist(rand.exp, prob = TRUE, breaks = 30, main = "Comparison of exponential density with its generation method", xlab = "Value of exponential distribution")
...
for (lambda in c(1, 1.5, 5)) {
	for (k in c(0.5, 2, 5)) {
		...
		hist(rand.weib, prob = TRUE, breaks = 30, main = "Comparison of Weibull density with its generation method", xlab = "Value of Weibull distribution")
...
hist(rand.cauchy, prob = TRUE, breaks = 100, main = "Comparison of Cauchy density with its generation method", xlab = "Value of Cauchy distribution")
